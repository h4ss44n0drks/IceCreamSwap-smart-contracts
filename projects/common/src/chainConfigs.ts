const chainConfigs = {
  ...
  xdc: {
    ...
    explorer: "",
    explorerApi: null,
    explorerApiKey: process.env.EXPLORER_API_KEY_XDC,
  ...
  shimmer: {
    ...
    explorer: "",
    explorerApi: null,
    explorerApiKey: process.env.EXPLORER_API_KEY_SHIMMER,
  ...
  telos: {
    ...
    explorer: "",
    explorerApi: null,
    explorerApiKey: process.env.EXPLORER_API_KEY_TELOS,
  ...
  bitgert: {
    ...
    explorer: "",
    explorerApi: null,
    explorerApiKey: process.env.EXPLORER_API_KEY_BITGERT,
  ...
  */
  neon: {
    ...
    explorer: "",
    explorerApi: null,
    explorerApiKey: process.env.EXPLORER_API_KEY_NEON,
    ice: "0x40375C92d9FAf44d2f9db9Bd9ba41a3317a2404f",
    bridgeDomainId: 13,
